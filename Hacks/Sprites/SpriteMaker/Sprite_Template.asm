...
;==================================================================================================================================
Sprite_Template_Main: ; LONG
{
	PHB : PHK : PLB ;We get the new working bank since we made a long jump
	    JSR Sprite_Template_JumpTable
	PLB
	RTL
}

Sprite_Template_JumpTable: 
{
	...
	dw Sprite_Template_Create ;0
	dw Sprite_Template_Update ;1
}

Sprite_Template_Create: ;Index 0
{
...
Sprite_Template_Update: ;Index 1 - Main Loop
{
    ;Todo: Fill me :P
	RTS
}

Sprite_Template_Draw: ;Main Draw Code (Complicated Part), you can find a draw code generator in my tools ;)
{
